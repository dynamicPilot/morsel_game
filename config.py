...
'set tail': ["Now tail is set and you can add one of your character to this tail.\nTo set character drag it to the suitable tail and use right mouse button to change tail side.\nPress 'Skip Character' to skip this step and 'Reset character' to return it.\nIf your men has suddenly disappeared, reset it.", ""],
